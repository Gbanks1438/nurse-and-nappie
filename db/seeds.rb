...
puts "🌱🌱🌱 Seeding Vacc Test…"
vacc1 = Vacc.create(date: Time.new(2022, 02, 17, 6, 00, 00, "-04:00"), vaccine: 'Test', abbreviation: 'TEST', dose: 'test', method: 'Test', notes: 'Test', baby_id: 1)
